...
# ---------------------------------------------------------------------------
CB_EMPLOYEE = "emp_"           # emp_{employee_id}
CB_FINISH_EMPLOYEE = "femp_"   # femp_{employee_id}

# Group mode callback prefixes
CB_SELECT_WORKER = "gw_"       # gw_{worker_id}
CB_DONE_SELECT = "gw_done"
CB_SELECT_PROCESS = "gp_"      # gp_{process_key}
CB_CONFIRM_YES = "gc_yes"
CB_CONFIRM_NO = "gc_no"
CB_FINISH_WORKER = "gfw_"      # gfw_{worker_id}
